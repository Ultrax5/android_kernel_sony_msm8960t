...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	unsigned int i;
	int cpu = get_cpu();
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_intellidemand2, unlock_policy_rwsem_write, unlock_policy_rwsem_write_k);
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_intellidemand2, lock_policy_rwsem_write, lock_policy_rwsem_write_k);
