...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	int cpu = get_cpu();
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_intellimm, sched_setscheduler_nocheck, sched_setscheduler_nocheck_k);
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_intellimm, unlock_policy_rwsem_write, unlock_policy_rwsem_write_k);
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_intellimm, lock_policy_rwsem_write, lock_policy_rwsem_write_k);
	...
	for_each_possible_cpu(i) {
...
#endif
		{
			...
			if (likely(!IS_ERR(pthread))) {
				...
				sched_setscheduler_nocheck_k(pthread,
							SCHED_FIFO, &param);
