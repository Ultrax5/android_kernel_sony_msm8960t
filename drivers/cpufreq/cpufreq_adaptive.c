...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_adaptive, sched_setscheduler_nocheck, sched_setscheduler_nocheck_k);
	...
	sched_setscheduler_nocheck_k(up_task, SCHED_FIFO, &param);
